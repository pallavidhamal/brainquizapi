...
import com.brainquizapi.exception.FileStorageException;
...
//	@Autowired FileStore fileStore;
	  ...
	  this.fileBaseLocation = fileStorageProperties.getUploadDir();
		/*
		 * this.fileAssociateBaseLocation =
		 * fileStorageProperties.getUploadassociateDir(); this.imagePathDir =
		 * fileStorageProperties.getImagepathDir();
